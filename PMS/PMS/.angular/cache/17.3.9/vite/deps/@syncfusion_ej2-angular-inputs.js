...
var inputs$9 = ["autocomplete", "cssClass", "enablePersistence", "enableRtl", "enabled", "floatLabelType", "htmlAttributes", "locale", "multiline", "placeholder", "readonly", "showClearButton", "type", "value", "width"];
var outputs$a = ["blur", "change", "created", "destroyed", "focus", "input", "valueChange"];
var twoWays$9 = ["value"];
...
var inputs$8 = ["cols", "cssClass", "enablePersistence", "enableRtl", "enabled", "floatLabelType", "htmlAttributes", "locale", "maxLength", "placeholder", "readonly", "resizeMode", "rows", "showClearButton", "value", "width"];
var outputs$9 = ["blur", "change", "created", "destroyed", "focus", "input", "valueChange"];
var twoWays$8 = ["value"];
...
TextAreaComponent.ɵfac = function TextAreaComponent_Factory(t) {
  return new (t || TextAreaComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ChangeDetectorRef));
};
...
var inputs$7 = ["cssClass", "currency", "currencyCode", "decimals", "enablePersistence", "enableRtl", "enabled", "floatLabelType", "format", "htmlAttributes", "locale", "max", "min", "placeholder", "readonly", "showClearButton", "showSpinButton", "step", "strictMode", "validateDecimalOnType", "value", "width"];
var outputs$8 = ["blur", "change", "created", "destroyed", "focus", "valueChange"];
var twoWays$7 = ["value"];
...
var inputs$6 = ["cssClass", "customCharacters", "enablePersistence", "enableRtl", "enabled", "floatLabelType", "htmlAttributes", "locale", "mask", "placeholder", "promptChar", "readonly", "showClearButton", "value", "width"];
...
var inputs$5 = ["colorRange", "cssClass", "customValues", "enableAnimation", "enableHtmlSanitizer", "enablePersistence", "enableRtl", "enabled", "limits", "locale", "max", "min", "orientation", "readonly", "showButtons", "step", "ticks", "tooltip", "type", "value", "width"];
var outputs$6 = ["focus", "blur", "change", "changed", "created", "renderedTicks", "renderingTicks", "tooltipChange", "valueChange"];
var twoWays$5 = ["value"];
...
var outputs$4 = ["focus", "blur", "actionComplete", "beforeRemove", "beforeUpload", "canceling", "change", "chunkFailure", "chunkSuccess", "chunkUploading", "clearing", "created", "failure", "fileListRendering", "pausing", "progress", "removing", "rendering", "resuming", "selected", "success", "uploading"];
var twoWays$4 = [];
...
var inputs$3 = ["columns", "createPopupOnClick", "cssClass", "disabled", "enableOpacity", "enablePersistence", "enableRtl", "inline", "locale", "mode", "modeSwitcher", "noColor", "presetColors", "showButtons", "value"];
var outputs$3 = ["focus", "blur", "beforeClose", "beforeModeSwitch", "beforeOpen", "beforeTileRender", "change", "created", "onModeSwitch", "open", "select", "valueChange"];
var twoWays$3 = ["value"];
...
var inputs$2 = ["backgroundColor", "backgroundImage", "disabled", "enablePersistence", "enableRtl", "isReadOnly", "locale", "maxStrokeWidth", "minStrokeWidth", "saveWithBackground", "strokeColor", "velocity"];
var outputs$2 = ["focus", "blur", "beforeSave", "change", "created"];
var twoWays$2 = [];
...
var inputs$1 = ["allowReset", "cssClass", "disabled", "emptyTemplate", "enableAnimation", "enablePersistence", "enableRtl", "enableSingleSelection", "fullTemplate", "itemsCount", "labelPosition", "labelTemplate", "locale", "min", "precision", "readOnly", "showLabel", "showTooltip", "tooltipTemplate", "value", "visible"];
var outputs$1 = ["focus", "blur", "beforeItemRender", "created", "onItemHover", "valueChanged", "valueChange"];
var twoWays$1 = ["value"];
...
var inputs = ["ariaLabels", "cssClass", "disabled", "enablePersistence", "enableRtl", "htmlAttributes", "length", "locale", "placeholder", "separator", "stylingMode", "type", "value"];
var outputs = ["blur", "created", "focus", "input", "valueChanged", "valueChange"];
var twoWays = ["value"];
...
OtpInputComponent.ɵfac = function OtpInputComponent_Factory(t) {
  return new (t || OtpInputComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ChangeDetectorRef));
};
